...
//
//
//  Created by SwaggerGenerator on 2021-03-06 09:20:58.405
//
...
public extension SGUrl.member_address_delete_id_post {
    static func rq(id:Int?,result:@escaping ((SKResult)->Void)){
        let item = SGUrl.member_address_delete_id_post()
...
public extension SGUrl.member_coupon_list_cart_type_get {
    static func rq(type:Int?,result:@escaping ((SKResult)->Void)){
        let item = SGUrl.member_coupon_list_cart_type_get()
        item.paramMap["type"]?.value = type
        sgRequest(item: item, result: result)
    }
}
public extension SGUrl.order_detail_orderId_get {
    static func rq(orderId:Int?,result:@escaping ((SKResult)->Void)){
        let item = SGUrl.order_detail_orderId_get()
        item.paramMap["orderId"]?.value = orderId
        sgRequest(item: item, result: result)
    }
}
public extension SGUrl.member_address_update_id_post {
    static func rq(address:UmsMemberReceiveAddress?,id:Int?,result:@escaping ((SKResult)->Void)){
        let item = SGUrl.member_address_update_id_post()
...
public extension SGUrl.member_address_id_get {
    static func rq(id:Int?,result:@escaping ((SKResult)->Void)){
        let item = SGUrl.member_address_id_get()
        item.paramMap["id"]?.value = id
        sgRequest(item: item, result: result)
    }
}
...
public extension SGUrl.home_productCateList_parentId_get {
    static func rq(parentId:Int?,result:@escaping ((SKResult)->Void)){
        let item = SGUrl.home_productCateList_parentId_get()
...
public extension SGUrl.product_detail_id_get {
    static func rq(id:Int?,result:@escaping ((SKResult)->Void)){
        let item = SGUrl.product_detail_id_get()
        item.paramMap["id"]?.value = id
        sgRequest(item: item, result: result)
    }
}
...
public extension SGUrl.brand_detail_brandId_get {
    static func rq(brandId:Int?,result:@escaping ((SKResult)->Void)){
        let item = SGUrl.brand_detail_brandId_get()
        item.paramMap["brandId"]?.value = brandId
        sgRequest(item: item, result: result)
    }
}
...
public extension SGUrl.member_coupon_listByProduct_productId_get {
    static func rq(productId:Int?,result:@escaping ((SKResult)->Void)){
        let item = SGUrl.member_coupon_listByProduct_productId_get()
        item.paramMap["productId"]?.value = productId
        sgRequest(item: item, result: result)
    }
}
...
public extension SGUrl.member_coupon_add_couponId_post {
    static func rq(couponId:Int?,result:@escaping ((SKResult)->Void)){
        let item = SGUrl.member_coupon_add_couponId_post()
...
public extension SGUrl.cart_getProduct_productId_get {
    static func rq(productId:Int?,result:@escaping ((SKResult)->Void)){
        let item = SGUrl.cart_getProduct_productId_get()
        item.paramMap["productId"]?.value = productId
        sgRequest(item: item, result: result)
    }
}
